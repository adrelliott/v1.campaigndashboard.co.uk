...
|--------------------------------------------------------------------------
|
| We define core classes for this app, and all toher classes estend these
|
| This allows us to create bespoke 'master classes' and put code used universally
| in these files. 
|  
| These classes are in application/libraries/core_classes
|
...
switch (ENVIRONMENT)
{
    case 'al_MBP_development':
        $base_url = 'http://localhost:8888/projects/leadfarm_v2/public_html/';
        break;
    case 'staging':
...
switch (ENVIRONMENT)
{
    case 'al_MBP_development':
        //Add more dev environments here...
        $config['log_threshold'] = 0; //On Dev server log everything
        break;    
    default:
       $config['log_threshold'] = 0; //On staging & production server only log PHP errors
        break;
}
