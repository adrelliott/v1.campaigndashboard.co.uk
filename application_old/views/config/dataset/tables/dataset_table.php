<?php 
    ...
    $table_headers = $this->table->get_table_headers($this->M_Datasets->cols, array('Action'));
    $table_data = $this->table->get_table_data($this->M_Datasets->cols, $datasets['all_datasets']);
